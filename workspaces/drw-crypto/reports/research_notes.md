...
- **Train**: 525,887 rows × 897 columns (3.3 GB parquet)
- **Test**: 538,150 rows × 896 columns (3.4 GB parquet)
...
3. **Memory optimization**: Raw 3.6GB → 1GB after downcasting (73% reduction needed)
...
- **Low R²**: Expect very low R² values (0.01-0.05 is normal for financial data)
...
4. [MEDIUM] Feature importance → top-K selection (K=100-300)
