...
| submission-geometry scoring | Candidate files can be ranked against real submitted anchors and failed directions before spending more Kaggle budget. | `kar drw-score-candidates <workspace>` |
