...
- 闭式 Ridge top-corr 特征模型：Pearson `0.125693`
- Pearson OOF simplex ensemble：Pearson `0.133473`
- 当前最佳本地 submission：`sub_ensemble_v005_v006_v007_v010_v011_v012_v015_v017.csv`
- 公开榜 top 约 `0.11 - 0.14`

结论：工具链已经能跑通并持续改善，当前本地 OOF 已进入公开榜强分区间附近。当前本地最佳已 dry-run 验证通过，尚未真实提交 Kaggle。下一步重点是验证 CV/LB 一致性、减少潜在时间泄露风险，并把 Ridge/XGB/LGBM ensemble 沉淀成更通用的 recipe。
