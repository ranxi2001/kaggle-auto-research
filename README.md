...
- 当前最佳本地 submission：`sub_ensemble_v002_v003_v004_v005_v006_v007_v008_v009_v010_v011_v012_v015.csv`
- 公开榜 top 约 `0.11 - 0.14`

结论：工具链已经能跑通并持续改善，但距离真正强结果还有差距。当前本地最佳已 dry-run 验证通过，尚未真实提交 Kaggle。下一步重点是补齐公开 notebook 缺失的高编号特征假设、优化 time-slice CV，并把 XGB/LGBM/Ridge ensemble 沉淀成可复用 recipe。
